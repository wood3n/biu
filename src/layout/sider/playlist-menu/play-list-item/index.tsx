...
const PlayListItem: React.FC<Props> = ({ selected, onClick, title, imgUrl, trackCount }) => {
  ...
  return (
    ...
    >
      ...
      <ListItemText
        disableTypography
        secondary={
          <Typography variant="caption" color={theme => theme.palette.text.secondary} paddingTop="4px">
            {`${trackCount}首歌曲`}
          </Typography>
        }
      >
        <OverflowText title={title}>{title}</OverflowText>
      </ListItemText>
    </MUIListItem>
  );
};
