 ...
 * 歌曲详情描述
 */
const PlaylistDescription: React.FC<Props> = ({ name, coverImgUrl, description, trackCount, createTime }) => (
  <div className={styles.playlistDescription}>
    <Image preview={false} width={200} height={200} src={coverImgUrl} fallback={IMAGE_ERR} className={styles.coverImage} />
