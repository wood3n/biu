...
const PageContainer = React.forwardRef<ScrollNodeRef, Props>(({ titleLeft, showScrollBoxShadow = true, children, ...props }, ref) => {
    ...
    >
      ...
      <Box sx={{ flex: "1 1 auto", overflowY: "auto" }}>
        ...
        >
          {children}
          <Fade in={trigger}>
            <Box onClick={handleScrollTop} role="presentation" sx={{ position: "fixed", bottom: 120, right: 16 }}>
